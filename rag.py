...
from utils import open_json, get_all_data, save_json, get_scrape_date, read_json_from_s3, write_json_to_s3
...
class RAG:
    ...
    def generate(self, date):
        ...
        data = read_json_from_s3(bucket_name='nba-bot', folder_path=f'extracted_data/{scrape_date}' )#get_all_data(f'extracted_data/{scrape_date}')
        for d in data:
            ...
            write_json_to_s3(json_content=d, bucket_name='nba-bot', key=file_path)
